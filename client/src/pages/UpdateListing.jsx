      ...
      <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
        <div className=' flex flex-col gap-4 flex-1'>
            ...
            <div className="flex flex-wrap gap-6">
                ...
                <div className="flex items-center gap-2">
                    <input type="number" id="regularPrice" min='100' max='50000' required
                    className='p-3 border border-gray-300 rounded-lg' 
        ...
        <div className=" flex flex-col flex-1 gap-4">
            ...
            <span className='font-normal text-gray-600 ml-2'>the first image
             ...
             <div className="flex gap-4">
                ...
                <button 
                disabled={uploading}
                type='button' onClick={handleImageSubmit} className='p-3 text-green-700 border border-green-700
