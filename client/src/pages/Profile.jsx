  ...
  return (
    <div className="p-3 max-w-lg mx-auto">
         ...
         className="text-sm self-center">
          {fileUploadError ? (
           ...
           upload (image must be less than 2mb )</span> 
            ...
            <span className="text-green-700">{`Uploading
              ${filePerc}%`}</span>
           ) : filePerc === 100 ? (
      ...
      <div className="flex justify-between mt-5">
        ...
        className="text-red-700 cursor-pointer">Sign
          out </span> 
      </div>
      ...
      <button onClick={handleShowListings} className="
      text-green-700 w-full"> Show Listings</button>
